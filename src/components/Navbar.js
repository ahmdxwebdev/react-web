    ...
    return (
        <nav className="navbar">
            <div className="navbar-container">
                <Link ro="/" className="navbar-logo" onClick={closeMobileMenu}>
                    TRVL &nbsp;<i className="far fa-images"></i>
                </Link>
                ...
                <ul className={click ? 'nav-menu active' : 'nav-menu'}>
                    ...
                    <li className='nav-item'><Link to='/signup' className='nav-links-mobile' onClick={closeMobileMenu}>Sign Up</Link></li>
                </ul>            
